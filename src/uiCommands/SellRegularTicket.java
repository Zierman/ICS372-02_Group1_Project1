		...
		public void call(UI ui)
		{
			...
			while(!done)
			{
				...
				try
				{
					...
					if(qty < 1) { throw new OutOfBoundsException("number of tickets must be postitive"); }
					...
					dateOfShow = UI.getDateFromInput("Enter the date of the showing");
				...
				{
					// show error message
					UI.outputError(e, "Unable to sell ticket because there are not enough seats availible");
				...
				{
					// show error message
					UI.outputError(e, "Unable to sell ticket because " + e.getMessage());
				...
				{
					// show error message
					UI.outputError(e, "Unable to sell ticket because no play is showing on that day");
