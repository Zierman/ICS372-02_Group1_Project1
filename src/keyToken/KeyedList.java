 ...
 *
 * @param <KeyedType> The type of the object in the list.
 * @param <KeyType> The data type of the key values.
 */
public interface KeyedList<KeyedType extends Keyed<KeyType>, KeyType> extends List<KeyedType>
{
	/**
	...
	/**
	 * Sets last key
	 * @param keyValue the key to set the last key's keyValue to. 
	 */
