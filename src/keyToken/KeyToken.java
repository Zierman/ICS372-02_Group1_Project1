 ...
 *
 * @param <KeyedType>
 *            They type of object this key is used for
 */
public abstract class KeyToken<KeyedType, KeyType extends Comparable<KeyType>>
		implements Serializable, Matchable<KeyToken<KeyedType, KeyType>>
{
	/**
	...
	{
		return obj instanceof KeyToken && toTestString()
				.equals(((KeyToken<KeyedType, KeyType>) obj).toTestString());
	}
