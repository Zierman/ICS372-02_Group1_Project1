...
/**
 * A discounted ticket to a play for a customer who buys it in advance and can
 * show a student id when claiming the ticket.
 * 
...
public class StudentAdvanceTicket extends Ticket
{
	...
	{
		super(dateOfShow, play, owner, 0.5, "student advance ticket",
				"Must show valid student id.", creditCard);
	}
}
